...
export const metadata: Metadata = {
  title: 'Frequently Asked Questions | Placid Asia',
  description: 'Find answers to common questions about acoustic measurement equipment, noise monitoring systems, and our services.',
  keywords: 'FAQ, acoustic equipment questions, noise monitoring help, technical support, buying guide',
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80">
              ค้นหาคำตอบสำหรับคำถามที่พบบ่อยเกี่ยวกับผลิตภัณฑ์ บริการ และการสนับสนุนของเรา
            </p>
          </div>
        </div>
      </section>
